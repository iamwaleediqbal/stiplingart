...
<html prefix="og: http://ogp.me/ns#" lang="en-GB" dir="ltr">
	<head>
		<title><?php echo isset($product['seo']['tagTitle']) ? $product['seo']['tagTitle'] : ''; ?> - Inspirational Art</title>
		<meta charset="utf-8" />
		...
		<meta property="og:url" content="https://stipplingart.com/product/?<?php echo isset($product['slug']) ? $product['slug'] : ''; ?>" />
...
<link rel="stylesheet" href="../res/swiper-bundle.min.css" />
		...
		<link rel="stylesheet" href="../product/style.css?2022-2-11-0-638061271922719887" media="screen,print" />
		<script src="../res/jquery.js?2022-2-11-0"></script>
		<script src="../res/x5engine.js?2022-2-11-0" data-files-version="2022-2-11-0"></script>
<script src="../res/swiper-bundle.min.js" ></script><script src="https://www.paypal.com/sdk/js?components=messages&client-id=AZRwW7EtfCoeWE_m3uRYAFUNt13y-s1PeQYSPKXBKFg2EooeMRs8oUw6dmmJmxxnNAXlNVD1HAjHs1QC&merchant-id=HQXYP3JAYCHLN&currency=USD" data-partner-attribution-id="Incomedia_Cart_PCP"></script>
		...
		<link rel="icon" href="../favicon.ico?2022-2-11-0-638061271922291888" type="image/vnd.microsoft.icon" />
<?php
	...
	<body>
		<div id="imPageExtContainer">
			<div id="imPageIntContainer">
				...
				<div id="imPage">
					<header id="imHeader">
						<h1 class="imHidden"><?php echo isset($product['name']) ? $product['name'] : ''; ?> - Inspirational Art</h1>
...
$(function () {$('#imStickyBar_imMenuObject_03_container ul li').not('.imMnMnSeparator').each(function () {    var $this = $(this), timeout = 0;    $this.on('mouseenter', function () {        if($(this).parents('#imStickyBar_imMenuObject_03_container-menu-opened').length > 0) return;         clearTimeout(timeout);        setTimeout(function () { $this.children('ul, .multiple-column').stop(false, false).fadeIn(); }, 250);    }).on('mouseleave', function () {        if($(this).parents('#imStickyBar_imMenuObject_03_container-menu-opened').length > 0) return;         timeout = setTimeout(function () { $this.children('ul, .multiple-column').stop(false, false).fadeOut(); }, 250);    });});});
					...
					<main id="imContent">
						...
						<script>x5engine.boot.push('x5engine.cart.productDetails.init({ target: \'im-product-container\', showRelatedProducts: true, innerWidths: \[1140,768,480,0]\, videoHiresWidth: 2560, videoHiresHeight: 1440, minThumbSize: 48, galleryWidthPerc: 50, galleryHeightPx: 400, galleryThumbnailHeightPx: 64 })', false, 6);</script>
